...
TEST_CASE("4x4 matrix initialization") {
  Matrix m;
  double initial[] = {1, 2,  3,  4,  5.5, 6.5, 7.5, 8.5,
                      9, 10, 11, 12, 0,   0,   0,   1};
...
TEST_CASE("Matrix multiplication -- matrix") {
  ...
  Matrix m3{4};
  double result[] = {16, 14, 22, 20, 36, 38, 58, 52,
                     34, 46, 68, 60, 0,  0,  0,  1};
...
TEST_CASE("Inverse: 4x4") {
  ...
  Matrix target{4};
  double t[] = {0.1411,  0.33129, 0.19632, -0.14724, 0.07975, -0.07362,
                0.06748, 1.69939, 0.25767, 0.30061,  0.14110, 0.64417,
                0,       0,       0,       1};
  m.from_array(initial);
  target.from_array(t);
